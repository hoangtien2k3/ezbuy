...
com.example.ezbuy
│
├── application/              # Layer ứng dụng (service, use case)
│   ├── service/
│   │   ├── UserService.java
│   │   └── ProductService.java
│   └── dto/
...
│       └── response/
│
├── domain/                   # Lớp domain model (Entity, Aggregate, ValueObject)
│   ├── model/
│   │   ├── User.java
│   │   ├── Product.java
│   │   └── Order.java
...
│   └── exception/
│
├── infrastructure/            # Giao tiếp hạ tầng (JPA, R2DBC, Migration, Cache,…)
│   ├── persistence/
│   │   ├── entity/
│   │   │   ├── UserEntity.java
│   │   │   └── ProductEntity.java
...
│
├── shared/                    # Tiện ích chung (constants, utils, logging,…)
│   ├── util/
│   │   └── DateUtils.java
│   └── constants/
│       └── ErrorCodes.java
│
└── EzbuyApplication.java
```
