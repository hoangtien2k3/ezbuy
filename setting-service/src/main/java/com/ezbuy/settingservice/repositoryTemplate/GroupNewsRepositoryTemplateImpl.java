...
public class GroupNewsRepositoryTemplateImpl extends BaseTemplateRepository implements GroupNewsRepositoryTemplate{
    ...
    private void buildQueryGroupNews(StringBuilder builder, Map<String, Object> params, SearchGroupNewsRequest request) {
        builder.append("select id, name, code, display_order, status, create_by, create_at, update_by, update_at from group_news where 1=1 ");
