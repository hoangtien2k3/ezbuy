...
public class MarketSectionRepositoryTemplateImpl extends BaseRepositoryTemplate implements MarketSectionRepositoryTemplate {
    ...
    private void buildQueryPages(StringBuilder builder, Map<String, Object> params, MarketSectionSearchRequest request) {
        builder.append("select * from market_section " +
                " where 1 = 1 ");
