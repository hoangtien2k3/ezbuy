...
public class NewsInfoController {
    ...
    public Mono<DataResponse<NewsInfo>> editServiceGroup(@PathVariable String id, @Valid @RequestBody CreateNewsInfoRequest request) {
    ...
    public Mono<DataResponse<List<NewsInfo>>> getAllServiceGroupActive() {
        return newsInfoService.getAllNewsInfoActive()
    ...
    public Mono<DataResponse<NewsDetailDTO>> getNewsDetailByNewsInfoId(@PathVariable String id) {
        return newsInfoService.getNewsDetailByNewsInfoId(id)
                .map(rs -> rs);
    }
    ...
    public Mono<DataResponse<List<RelateNewsDTO>>> getRelateNewsByGroupNewsId(@PathVariable String id) {
        return newsInfoService.getRelateNewsByGroupNewsId(id)
                .map(rs -> rs);
    }
}
