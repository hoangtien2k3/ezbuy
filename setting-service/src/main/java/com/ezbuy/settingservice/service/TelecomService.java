...
public interface TelecomService {
    Mono<DataResponse<List<TelecomDTO>>> getTelecomService(List<String> ids, List<String> serviceAliases, List<String> originIds);
    ...
    Mono<DataResponse<List<TelecomServiceConfigDTO>>> getTelecomServiceConfig(List<String> telecomServiceIds, List<String> originalIds, String syncType);
