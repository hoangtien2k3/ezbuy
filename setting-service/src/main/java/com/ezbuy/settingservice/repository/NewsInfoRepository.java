...
public interface NewsInfoRepository extends R2dbcRepository<NewsInfo, UUID> {
    ...
    Mono<NewsInfo> updateNewsInfo(String id, String code, String title, Integer displayOrder, Integer status, String groupNewsId, String state, String summary, String user, String navigatorUrl);
