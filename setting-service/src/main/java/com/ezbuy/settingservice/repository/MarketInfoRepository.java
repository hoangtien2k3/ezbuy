...
public interface MarketInfoRepository extends R2dbcRepository<MarketInfo, UUID> {
    ...
    @Query("select * from market_info where service_id =:telecomServiceId and (service_alias =:serviceAlias or :serviceAlias is null)")
    ...
    @Query(value = "update market_info " +
            ...
            "where id = :id")
    Mono<MarketInfo> updateMarketInfo(String serviceId, String title, String navigatorUrl, Integer marketOrder, String marketImageUrl, Integer status, String user, String id, String serviceAlias);
