...
public class OrderV2ClientUtils {
    private static final String ORDER_REQUEST_TEMPLATE = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.order.viettel.com/\">\n" +
            "   <soapenv:Header>\n" +
    ...
    private static final String GET_ORDER_HISTORY_HUB_BODY_TEMPLATE =
    ...
    public static String getOrderHistoryHubPayload(String taxCode, String individualId, List<String> systemTypeList, List<String> orderTypeList, Integer limit, Integer pageIndex, String state, String username, String password) {
        ...
        String body = MessageFormat.format(GET_ORDER_HISTORY_HUB_BODY_TEMPLATE, individualId, systemTypeParam.toString(), orderTypeParam.toString(), limit, stateParam, pageIndex, taxCode);
