...
public class CmClientUtils {
    ...
    private static final String CM_REQUEST_TEMPLATE = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" +
            "   <soap:Body>\n" +
    ...
    public static String getGetListSubscriberByIdnoTemplate(String idNo, String telecomServiceId, String username, String password) {
    ...
    public static String getGetCustomerSubscriberSmeInfoTemplate(String idNo, String isdn, String telecomServiceId, String username, String password) {
