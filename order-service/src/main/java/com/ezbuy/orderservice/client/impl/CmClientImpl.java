...
public class CmClientImpl implements CmClient {
    ...
    public CmClientImpl(BaseSoapClient soapClient, @Qualifier("cmClient") WebClient cmClient, CmProperties cmProperties) {
    ...
    @Override
    public Mono<Optional<GetCustomerSubscriberSmeInfoResponse>> getCustomerSubscriberSmeInfo(String idNo, String isdn, String telecomServiceId) {
        String payload = CmClientUtils.getGetCustomerSubscriberSmeInfoTemplate(idNo, isdn, telecomServiceId, cmProperties.getUsername(), cmProperties.getPassword());
