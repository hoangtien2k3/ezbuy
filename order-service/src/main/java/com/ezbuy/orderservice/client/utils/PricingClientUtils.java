...
public class PricingClientUtils {
    private static final String PRICING_REQUEST_TEMPLATE = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.order.bccs.viettel.com/\">\n" +
            "   <soapenv:Header>\n" +
