...
public class ProfileServiceImpl implements ProfileService {
    ...
    @Override
    public Mono<Optional<GetListProductOfferingRecordResponse>> getListProductOfferingRecord(
            GetListProductOfferingRecordRequest request) {
        return profileClient.getListProductOfferingRecordResponse(request).doOnError(err -> {
    ...
    public Mono<Optional<GetListServiceRecordResponse>> getListServiceRecord(GetListServiceRecordRequest request) {
        return profileClient.getListServiceRecord(request).doOnError(err -> {
            log.error("Handle Profile Error", err);
        });
    }
}
