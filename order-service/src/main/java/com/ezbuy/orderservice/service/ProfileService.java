...
public interface ProfileService {
    /**
     * Ham nay goi de tra ve danh sach ho so theo danh sach dich vu dua vao
     * telecomServiceAlias BCCS
     *
     * @param request
     ...
     *
     * @param request
     *            truyen vao danh sach ma goi cuoc
     * @return danh sach ho so voi ma goi cuoc tuong ung
     */
    Mono<Optional<GetListProductOfferingRecordResponse>> getListProductOfferingRecord(
