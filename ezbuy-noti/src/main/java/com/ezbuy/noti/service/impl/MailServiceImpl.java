...
import com.ezbuy.noti.common.CommonConstants;
...
import static com.ezbuy.noti.common.CommonConstants.*;
import static com.ezbuy.noti.common.CommonConstants.TemplateMail.*;
...
public class MailServiceImpl implements MailService {
    ...
    private String renderContent(TransmissionNotiDTO transmissionNoti) {
        ...
        return switch (templateMail) {
            case SIGN_UP, FORGOT_PASSWORD -> renderOtpMailContent(transmissionNoti);
