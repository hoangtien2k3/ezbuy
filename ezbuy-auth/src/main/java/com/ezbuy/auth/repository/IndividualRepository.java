...
public interface IndividualRepository extends R2dbcRepository<IndividualEntity, String> {
    @Query("""
            ...
            WHERE LOWER(code) = LOWER(:code)
              AND status = :status
            """)
    Mono<IndividualEntity> findByCode(String code, Integer status);
    ...
    @Query("""
            ...
            WHERE id = :id
              AND status = :status
            """)
    Mono<IndividualEntity> findByIdAndState(String id, Integer status);
    ...
    @Query("""
            ...
            WHERE id = :id
              AND status = :status
            """)
    Mono<IndividualEntity> getIndividualByIdAnAndStatus(String id, Integer status);

    @Query("""
            SELECT * FROM individual
            WHERE id = :id
            """)
    Mono<IndividualEntity> getIndividualById(String id);
    ...
    @Query("""
            ...
            GROUP BY i.id
            """)
    Mono<IndividualEntity> findIndividualIdByEmail(String email, String organizationId);
    ...
    @Query("""
            ...
            LIMIT 1
            """)
    Mono<IndividualEntity> findByEmailAccount(String emailAccount);
    ...
    @Query("""
            ...
            """)
    Mono<IndividualEntity> findByUsernameIgnoreCase(String username);
    ...
    @Query("""
            ...
            WHERE status = 1
              AND code = :code
            """)
    Mono<IndividualEntity> findIdByCode(String code);
    ...
    @Query("""
            ...
            WHERE i.status = 1
              ...
              AND ou.code = :code
            """)
    Mono<IndividualEntity> findIdByUsernameWithOrganizationId(String username, String organizationId, String code);
    ...
    @Query("""
            ...
            """)
    Mono<IndividualEntity> findByUsername(String username);

    @Query("""
            SELECT * FROM individual
            WHERE username = :username
            """)
    Flux<IndividualEntity> findAllByUserName(String username);
