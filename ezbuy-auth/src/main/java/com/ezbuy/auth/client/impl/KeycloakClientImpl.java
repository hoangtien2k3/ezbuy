...
import com.ezbuy.auth.model.request.ClientLogin;
import com.ezbuy.auth.model.request.CreateRoleUserKeycloakRequest;
import com.ezbuy.auth.model.request.CreateUserKeycloakRequest;
import com.ezbuy.auth.model.request.CredentialKeycloakRequest;
import com.ezbuy.auth.model.request.EmployeeCreateRequest;
import com.ezbuy.auth.model.request.LoginRequest;
import com.ezbuy.auth.model.request.LoginRequestSync;
...
import com.ezbuy.auth.model.request.UpdateUserKeycloakRequest;
...
public class KeycloakClientImpl implements KeyCloakClient {
    ...
    public Mono<String> createUser(EmployeeCreateRequest employeeCreateRequest, String password, String token) {
        ...
        if (DataUtil.isNullOrEmpty(groupIds)) return createUserInKeycloak(request, token);
