...
import com.ezbuy.auth.application.dto.request.EmployeePermissionRequest;
...
import com.ezbuy.auth.infrastructure.repository.IndividualOrgPermissionRepo;
import com.ezbuy.auth.application.service.PermissionPolicyService;
...
public class UtilServiceImpl implements UtilService {
    ...
    public Mono<List<PermissionPolicyEntity>> createEmployeePermission(
            List<EmployeePermissionRequest> employeeUpdateRequest, IndividualEntity individual, String organizationId) {
        return Flux.fromIterable(employeeUpdateRequest)
                .flatMap(employeePr -> indOrgPermissionRepo
                        ...
                        .flatMap(rs -> {
                            ...
                            IndividualOrganizationPermissionsEntity individualOrg = new IndividualOrganizationPermissionsEntity();
                            if (rs.isEmpty()) {
