...
import com.viettel.sme.ratingservice.repository.RatingHistoryRepository;
...
public class RatingHistoryServiceImpl extends BaseServiceHandler implements RatingHistoryService {
    ...
    @Override
    public Mono<RatingHistory> createRatingHistory(String ratingId, Long ratingBf, Long ratingAf, String contentBf, String contentAf, String approveBy, LocalDateTime approveAt, Rating.RatingState state) {
