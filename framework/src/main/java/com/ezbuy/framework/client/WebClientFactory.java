...
//            exchangeStrategies.defaultHeader(Constants.Security.AUTHORIZATION, Constants.Security.BEARER + " " + Base64Utils
...
//        WebClient webClient = exchangeStrategies.clientConnector(clientConnector).build();
//        return webClient;
//    }
//
...
//        if (DataUtil.isNullOrEmpty(webClientProperties.getName()) || DataUtil.isNullOrEmpty(webClientProperties.getAddress())) {
//            return false;
//        }
//        return true;
//    }
