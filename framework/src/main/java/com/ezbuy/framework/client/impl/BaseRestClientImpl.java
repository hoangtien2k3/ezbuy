...
//        return webClient
//                .get()package com.ezbuy.framework.client.impl;
//
//import com.ezbuy.framework.client.BaseRestClient;
//import com.ezbuy.framework.constants.CommonErrorCode;
//import com.ezbuy.framework.constants.Constants;
...
//                                .flatMap(errorBody -> {
//                                    log.info("call post error {}", errorBody);
...
//                        .bodyToMono(String.class)
//                        .map(response -> {
//                            return processReturn(response, resultClass);
//                        })
//                        .onErrorResume(WebClientResponseException.class, e -> {
...
//                return !DataUtil.isNullOrEmpty(payload)
//                        ? payload
...
//                        .uri(url)
//                        .headers(httpHeaders -> httpHeaders.addAll(getSafeRestHeader(headerList)))
//                        .bodyValue(ObjectMapperUtil.convertObjectToJson(payload))
//                        .retrieve()
//                        .onStatus(HttpStatus::isError, response -> response.bodyToMono(String.class)
//                                .flatMap(errorBody -> {
//                                    log.info("call post error {}", errorBody);
...
//                return WebClient.builder().clientConnector(connector).defaultHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_FORM_URLENCODED_VALUE)
//                        .build();
//            }
//
//            @Override
...
//                        .uri(url)
//                        .headers(httpHeaders -> httpHeaders.addAll(getSafeRestHeader(headerList)))
//                        .bodyValue(ObjectMapperUtil.convertObjectToJsonForLocalDateTime(payload))
//                        .retrieve()
//                        .onStatus(HttpStatus::isError, response -> response.bodyToMono(String.class)
//                                .flatMap(errorBody -> {
//                                    log.info("call post error {}", errorBody);
