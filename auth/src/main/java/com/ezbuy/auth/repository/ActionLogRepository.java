...
public interface ActionLogRepository extends R2dbcRepository<ActionLog, String> {
     ...
     *
     * @param dateReport the date for which to count login actions
     * @param type the type of action to count
     * @return a Mono emitting the count of login actions for the specified date and type
     */
