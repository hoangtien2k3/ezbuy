...
import com.ezbuy.auth.model.postgresql.PermissionPolicy;
...
public interface IndOrgPermissionRepo extends R2dbcRepository<PermissionPolicy, UUID> {
    ...
    @Query(value = "select count(distinct (iop.organization_id))\n" +
            "from individual_organization_permissions iop\n" +
     ...
     * @return
     */
    @Query(value = "select organization_id org_id, individual_id individual_id, user_id\n" +
     ...
     * @return
     */
    @Query(value = "select exists(select * from individual_organization_permissions iop\n" +
    ...
    Mono<Boolean> checkExistRoleInHub(String individualId, String keycloakName, String clientId, String policyId, String type, String orgId, String keycloakId);
     ...
     * @return
     */
    @Query(value = "select id from individual_organization_permissions\n" +
