...
public class ProductClientUtils {
    ...
    private static final String PRODUCT_REQUEST_TEMPLATE =
    ...
    private static final String GET_PRODUCT_TEMPLATE_BY_IDS = "<ser:getListProductOfferTemplateByListIds>\n"
            + "   {0}\n" + "   <inputConfigPhase>{1}</inputConfigPhase>\n"
            + "</ser:getListProductOfferTemplateByListIds>";

    private static final String GET_PRODUCT_TEMPLATE =
    ...
    private static final String GET_PRODUCT_FILTER =
    ...
    public static final String GET_LIST_PRODUCT_OFFERING_COMBO_FOR_HUB_SME =
            "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.product.bccs.viettel.com/\">\n"
                    + "   <soapenv:Header>\n"
                    + "      <wsse:Security soapenv:mustUnderstand=\"1\" xmlns:wsse=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\" xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">\n"
                    + "         <wsse:UsernameToken wsu:Id=\"UsernameToken-32ce50e8-4a5d-4040-af71-c3428d92daa7\">\n"
    ...
    public static final String GET_LIST_TEMPLATE_COMBO_FOR_HUB_SME =
            "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ser=\"http://service.product.bccs.viettel.com/\">\n"
                    + "   <soapenv:Header>\n"
                    + "      <wsse:Security soapenv:mustUnderstand=\"1\" xmlns:wsse=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\" xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">\n"
                    + "         <wsse:UsernameToken wsu:Id=\"UsernameToken-32ce50e8-4a5d-4040-af71-c3428d92daa7\">\n"
    ...
    private static final String GET_LIST_TEMPLATE_COMBO_FOR_HUB_SME_BODY =
            "<ser:getListTemplateComboForHubSme>\n" + "         {0}\n" + "      </ser:getListTemplateComboForHubSme>";

    private static final String GET_PRODUCT_TEMPLATE_DETAIL = "<ser:getProductTemplateDetail>\n" + "   {0}\n"
    ...
    public static String getSearchProductTemplateByIdsPayload(
            List<String> templateIds, String username, String password) {
        ...
        String bodyDataValue =
                DataWsUtil.getDataByTag(bodyReq, "<productTemplateByIdRequest>", "</productTemplateByIdRequest>");
    ...
    public static String getSearchProductTemplateByIdsPayloadV2(
            List<String> templateIds, String username, String password) {
        StringBuilder sb = new StringBuilder();
        if (!DataUtil.isNullOrEmpty(templateIds)) {
            for (String templateId : templateIds) {
                sb.append("<lstTemplateIds>").append(templateId).append("</lstTemplateIds>");
            }
        }
    ...
    public static String getSearchProductTemplatePayload(
            String telecomServiceId, ApiUtils utils, String username, String password, List<String> priceTypes) {
        ...
        String bodyDataValue =
                DataWsUtil.getDataByTag(bodyReq, "<getLstTemplateOfferRequest>", "</getLstTemplateOfferRequest>");
    ...
    public static String getProductOffering(
            String productOfferingId, String staffCode, String username, String password) {
        ...
        String bodyReq =
                MarshallerFactory.convertObjectToXML(getProductOfferingRequest, GetProductOfferingRequest.class);
        String bodyDataValue =
                DataWsUtil.getDataByTag(bodyReq, "<getProductOfferingRequest>", "</getProductOfferingRequest>");
        String body = MessageFormat.format(GET_PRODUCT_OFFERING, bodyDataValue);
        return getProductRequest(username, password, body);
    }

    public static String getListProductOfferingComboForHubSme(
            GetListProductOfferingComboForHubSmeRequest request, String username, String password) {
        String bodyReq =
                MarshallerFactory.convertObjectToXML(request, GetListProductOfferingComboForHubSmeRequest.class);
        String bodyDataValue = DataWsUtil.getDataByTag(
                bodyReq,
                "<getListProductOfferingComboForHubSmeRequest>",
                "</getListProductOfferingComboForHubSmeRequest>");
    ...
    public static String getListTemplateComboForHubSmeBody(String productOfferingId, String username, String password) {
        ...
        if (!DataUtil.isNullOrEmpty(productOfferingId)) {
            ...
            bodyDataValue = DataWsUtil.getDataByTag(
                    bodyReq, "<getListTemplateComboForHubSmeRequest>", "</getListTemplateComboForHubSmeRequest>");
        }
    ...
    public static String getProductTemplateDetailPayload(
            GetProductTemplateDetailRequest getProductTemplateDetailRequest, String username, String password) {
        StringBuilder sb = new StringBuilder("");
        if (!DataUtil.isNullOrEmpty(getProductTemplateDetailRequest.getTemplateCodeList())) {
            for (String templateCode : getProductTemplateDetailRequest.getTemplateCodeList()) {
                sb.append("<templateCodes>").append(templateCode).append("</templateCodes>");
            }
        }
