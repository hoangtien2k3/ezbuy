...
//
// String payload = CMClientUtils.getListSubscriberByIdNo(idNo,
// cmProperties.getUsername(), cmProperties.getPassword());
//
// return baseSoapClient.call(cmClient, null, payload,
// CustomerSubscribeInfoCMResponse.class)
// .map(response -> {
// if (DataUtil.isNullOrEmpty(response)) {
// return new ArrayList<>();
// }
// CustomerSubscribeInfoCMResponse cmObject = (CustomerSubscribeInfoCMResponse)
...
// })
// .doOnError(err -> log.error("Exception when call soap
// getListSubscriberByIdno: ", err))
...
//
// @Override
// public Mono<CustomerSubscribeInfoCMResponse>
// getCustomerSubscriberSmeInfo(Long telecomServiceId, String idNo, String isdn)
// {
// String payload = CMClientUtils.getCustomerSubscriberSmeInfo(telecomServiceId,
// idNo, isdn, cmProperties.getUsername(), cmProperties.getPassword());
//
