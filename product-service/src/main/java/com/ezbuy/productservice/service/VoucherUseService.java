...
public interface VoucherUseService {
    ...
    /**
     * Ham validate voucher da duoc su dung hay chua theo voucher code va nguoi nhan voucher
     * @param code
    ...
    /**
     * Ham update thong tin voucher use va voucher cho luong voucher tang khi thanh toan
     * @param request
     * @return
     */
    ...
    /**
     * Ham update thong tin voucher use va voucher trans cho luong su dung voucher khi thanh toan
     * @param request
     * @return
     */
