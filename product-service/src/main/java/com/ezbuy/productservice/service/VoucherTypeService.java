...
public interface VoucherTypeService {
    ...
    /**
     * Author: HaPT Ham nay dung de tra ve tat ca ban ghi loai khuyen mai
     *
     ...
     *
     * @param request
     * @return mot list cac ban ghi va thong tin phan trang( tong so ban ghi, so
     *         trang, trang hien tai)
     */
    Mono<SearchVoucherTypeResponse> search(SearchVoucherTypeRequest request);

    /**
     * Ham nay de xoa mot ban ghi loai khuyen mai( mass delete) dat truong status ve
     * 0
     *
     * @param id
