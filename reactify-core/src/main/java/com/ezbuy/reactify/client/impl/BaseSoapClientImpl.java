package com.ezbuy.reactify.client.impl;

import com.ezbuy.reactify.DataUtil;
import com.ezbuy.reactify.DataWsUtil;
import com.ezbuy.reactify.Translator;
import com.ezbuy.reactify.client.BaseSoapClient;
 ...
 * </p>
 *
 * @param <T> The type of the result object expected from the API response.
 */
@Slf4j
@Service
public class BaseSoapClientImpl<T> implements BaseSoapClient<T> {
     ...
     * @param headerList  Headers to include in the SOAP request.
     * @param payload     The request payload to send.
     * @param resultClass The expected result class type for deserialization.
     ...
     * deserialization.
     *
     * @param realData The XML data to parse.
     * @param clz      The class type to parse into.
     ...
     * are provided.
     *
     * @param headerList The headers to include in the SOAP request.
