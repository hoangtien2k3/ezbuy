package com.ezbuy.authservice.service.impl; // package com.ezbuy.auth.service.impl;
//
...
// @Override
// @Transactional
// public Mono<DataResponse<OrganizationUnit>>
// createOrganizationUnit(CreateOrganizationUnitRequest request, String
// organizationId) {
...
//
// @Override
// public Mono<Optional<Organization>>
// createOrganization(CreateOrganizationRequest request, String createUser,
// String individualId, boolean isTrustedIdentify) {
// var posIdForRep =
// positionsRepository.getIdByCode(AuthConstants.PositionCode.REPRESENTATIVE);
// var posIdForOwner =
// positionsRepository.getIdByCode(AuthConstants.PositionCode.OWNER);
// var getUnitTypeIdByCode =
// unitTypeRepository.getUnitTypeIdByCode(AuthConstants.UnitTypeCode.DEPARTMENT);
//
...
//
// OrganizationUnit organizationUnit = initOrgUnit(request, organizationId,
// createUser,
// posId.getT3());
// String organizationUnitId = organizationUnit.getId();
//
// List<TenantIdentify> tenantIdentifiesForOrg = initTenants(request,
...
//
// List<TenantIdentify> tenantIdentifiesForRep =
// request.getRepresentative().getIdentifies();
...
// var saveTenantIdentifyForOrg =
// tenantIdentifyRepo.saveAll(tenantIdentifiesForOrg).collectList();
//// var saveTenantIdentifyForRep =
// tenantIdentifyRepo.saveAll(tenantIdentifiesForRep);
// var saveIndividualUnitPosForRep =
// unitPositionRepo.save(individualUnitPosition);
// var saveOwner = unitPositionRepo.save(ownerUnitPos);
//
// return Mono.zip(saveOrganization, saveOrganizationUnit,
// saveTenantIdentifyForOrg,
// saveRepresentative)
